...
export const metadata = {
  title:
    "Staycation + 1 Area with Decorations — Portfolio | Azure Staycation by Siaos",
  description:
    "Real photos from our Staycation + 1 Area with Decorations set ups — single-area birthday, anniversary, and romantic surprise decorations from actual client bookings.",
};
