...
export const metadata = {
  title: "Proposal Terms and Conditions — Azure Staycation by Siaos",
  description:
    ...
    <div className="flex flex-col">
      ...
      <article className="mx-auto max-w-2xl px-6 pt-16 pb-24">
        ...
        <p className="text-sm text-ink-soft mt-14 pt-6 border-t border-ink/10">
          Looking for general staycation booking terms instead?{" "}
          <Link href="/terms-and-conditions" className="text-clay-deep underline">
